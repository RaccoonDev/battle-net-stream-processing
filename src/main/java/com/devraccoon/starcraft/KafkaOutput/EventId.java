 ...
 */
package com.devraccoon.starcraft.KafkaOutput;
...
public class EventId extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 8831244774422166711L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"EventId\",\"namespace\":\"com.devraccoon.starcraft.KafkaOutput\",\"fields\":[{\"name\":\"id\",\"type\":\"string\"}]}");
   ...
   */
  public EventId(java.lang.CharSequence id) {
    this.id = id;
  }
   ...
   */
  public static com.devraccoon.starcraft.KafkaOutput.EventId.Builder newBuilder() {
    return new com.devraccoon.starcraft.KafkaOutput.EventId.Builder();
  }
   ...
   * @return A new EventId RecordBuilder
   */
  public static com.devraccoon.starcraft.KafkaOutput.EventId.Builder newBuilder(com.devraccoon.starcraft.KafkaOutput.EventId.Builder other) {
    if (other == null) {
      return new com.devraccoon.starcraft.KafkaOutput.EventId.Builder();
    } else {
      return new com.devraccoon.starcraft.KafkaOutput.EventId.Builder(other);
    }
  }
   ...
   * @return A new EventId RecordBuilder
   */
  public static com.devraccoon.starcraft.KafkaOutput.EventId.Builder newBuilder(com.devraccoon.starcraft.KafkaOutput.EventId other) {
    if (other == null) {
      return new com.devraccoon.starcraft.KafkaOutput.EventId.Builder();
    } else {
      return new com.devraccoon.starcraft.KafkaOutput.EventId.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<EventId>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.devraccoon.starcraft.KafkaOutput.EventId.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.devraccoon.starcraft.KafkaOutput.EventId other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.devraccoon.starcraft.KafkaOutput.EventId.Builder setId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.devraccoon.starcraft.KafkaOutput.EventId.Builder clearId() {
      id = null;
